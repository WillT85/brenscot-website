...
const sections: { heading: string; body: (string | { items: string[] })[] }[] = [
  ...
  },
  {
    ...
    body: [
      'Indevelop may collect and hold Personal Information such as your name, contact details (including your address, phone numbers, and emails, whether personal or for work), business and project information, ABN/ACN, financial and payment details where relevant, and product, service, and project preferences.',
    ],
  },
  {
    heading: '3. Why do we collect Personal Information?',
    body: [
      '3.1 Indevelop collects Personal Information from clients, purchasers, tenants, employees, contractors, suppliers, investors, and other individuals where reasonably necessary for one or more of our functions or activities, including to deliver our property development projects, manage tenancies and partner relationships, and to keep you informed of relevant developments and opportunities.',
  ...
  },
  {
    ...
    body: [
      '5.1 Indevelop will not collect any Personal Information about users of our website except when they knowingly provide it or as otherwise described below. For example, Indevelop may collect Personal Information from users of the Website when they:',
      { items: [
        '(a) complete an online form, including registering to receive updates, promotional material, or other information; and/or',
        '(b) otherwise correspond with Indevelop.',
      ]},
      'Click Stream Data',
      '5.2 When you visit and browse our website, our website host may collect Personal Information for statistical, reporting, and maintenance purposes. The Personal Information collected by our website host will not be used to identify you. The information may include:',
      { items: [
      ...
      '5.3 Indevelop\u2019s website host uses this information to administer and improve the performance of our website, including to assist with the diagnosis of and to provide support for any issues with our website or services.',
      'Cookies',
      ...
      '5.5 If you access our Website, a cookie may be downloaded onto your computer\u2019s hard drive when you first visit our Website. You can adjust your internet browser to disable cookies; however, Indevelop may not be able to provide you with all the service or functionality you require on our website if you choose to do so.',
      'Web Beacons',
      '5.6 Web beacons are images that originate from a third-party site to track visitor activities. Indevelop may use web beacons to collect aggregate data and provide this information to our website host to administer and improve the performance of our website.',
      'Links to external websites',
      '5.7 If you follow any links to external websites from our Website, this Privacy Policy will not apply to those websites, which may have their own policies relating to privacy and data collection and website usage. If you choose to access any linked website or provide any Personal Information on such websites, you should review their policies and terms of use to learn more about how they may use your Personal Information. Indevelop is not responsible for and will not be liable for the operations or policies of any external website.',
    ],
  },
  {
    heading: '6. How Indevelop uses the Personal Information it collects about you',
    body: [
      '6.1 Indevelop uses the Personal Information it collects about you for our business functions and activities, which may include the following:',
      { items: [
        '(a) to provide you with information, products, or services you have requested;',
        '(b) to manage and deliver our development, sales, leasing, and tenancy services;',
        '(c) to promote and market our projects and services to you;',
        '(d) to personalise and customise your experiences on our Website;',
        '(e) to help Indevelop research the needs of its clients and partners;',
        '(f) to conduct research for the purposes of improving existing products or services or creating new ones;',
        '(g) to provide you with ongoing information about Indevelop and its activities;',
      ...
      '6.2 Indevelop may use your Personal Information for a secondary purpose if that secondary purpose is related to those purposes listed in clause 6.1, if we have your consent, or if otherwise provided for under the Privacy Act.',
      '6.3 Indevelop may use your Personal Information to provide you with direct marketing materials if you would reasonably expect us to or if you consent to receive direct marketing materials. Direct marketing material may include promotional material about Indevelop or the products or services offered by Indevelop.',
  ...
  },
  {
    ...
    body: [
      '7.1 Depending on the nature of your relationship with Indevelop, we may disclose your Personal Information to officers and employees of Indevelop, other businesses within our group of companies, service providers and contractors who assist us in our business operations when necessary to perform their services, government bodies, regulatory authorities and law enforcement bodies, and third parties, or otherwise as required by law.',
      '7.2 Indevelop may also disclose your Personal Information to our website host or service providers in certain limited circumstances, for example, when our website experiences a technical problem or to ensure that it operates in an effective and secure manner. Where we do share your Personal Information with a service provider, we would only do so if that party has agreed to comply with our privacy standards as described in this Privacy Policy.',
      ...
      '7.4 You may authorise Indevelop to disclose Personal Information that it holds about you to your adviser, administrator, or another person nominated by you.',
      '7.5 Unless otherwise specified in this Privacy Policy, Indevelop or Indevelop\u2019s website host will not disclose any of your Personal Information to any other organisation unless the disclosure is required by law or is otherwise permitted by the Privacy Act or is with your consent.',
    ],
  },
  {
  ...
  {
    heading: '9. Storage and security of Personal Information held by Indevelop',
    body: [
      '9.1 Indevelop will take reasonable steps to protect your Personal Information from misuse, interference, and loss, and from unauthorised access, modification, or disclosure.',
      '9.2 Indevelop aims to keep your Personal Information secure and up to date. We will comply with our obligations under the Privacy Act in relation to any Personal Information that we handle, including information held on Indevelop\u2019s computer systems.',
      '9.3 Personal Information that is held by Indevelop in hard copy is stored securely on its premises and is only disclosed or used for the purposes described in this Privacy Policy.',
    ],
  },
  {
    heading: '10. Updating and correcting your Personal Information',
    body: [
      'We will take reasonable steps to ensure that the Personal Information we hold is accurate, up to date, and complete. You can update your Personal Information at any time by contacting Indevelop in any of the ways specified in clause 13. Indevelop welcomes any changes to your Personal Information to keep our records up to date.',
    ],
  },
  {
    heading: '11. How long will Indevelop keep your Personal Information?',
    body: [
  ...
  {
    heading: '12. Finding out what Personal Information Indevelop holds about you',
    body: [
      '12.1 You are entitled to access Personal Information that Indevelop holds about you. If you request access to your Personal Information, we will grant your request unless providing you with access would unreasonably impact upon the privacy of others or is not otherwise permitted under the Australian Privacy Principles or at law. If we refuse your request to access your Personal Information, we will provide you with written reasons for the refusal.',
      '12.2 A request for access can be made by contacting Indevelop in any of the ways specified in clause 13.',
    ],
  },
  {
    heading: '13. How to contact us and more information',
    body: [
      '13.1 If you feel that your privacy has not been respected or that Indevelop has conducted itself inconsistently with this Privacy Policy, the Australian Privacy Principles, a registered APP Code, and/or the Privacy Act in respect of your Personal Information, or for any other queries, problems, complaints, or communication in relation to this Privacy Policy, please contact us in any of the following ways:',
      { items: [
        'Email: enquiries@indevelop.com.au',
        'Phone: +61 (0)7 3000 0000',
        'Post: Attn: Privacy Officer, Indevelop Pty Ltd, Level 45 The Aurora Tower, 1 Queen Street, Brisbane QLD 4000',
      ]},
    ...
    <Layout>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-8">
          ...
          >
            <p>
              Indevelop Pty Ltd and its related entities (referred to as <em>Indevelop</em>, <em>we</em>, <em>us</em>, or <em>our</em>) are committed to the protection of your Personal Information in accordance with the Australian Privacy Principles set out in the <em>Privacy Act 1988</em> (Cth) as amended by the <em>Privacy Amendment (Enhancing Privacy Protection) Act 2012</em> (Cth) (the <em>Privacy Act</em>).
            </p>
            <p>
              This Privacy Policy describes the way Indevelop collects, holds, and uses Personal Information that is covered by the Privacy Act. It is not intended to cover categories of Personal Information that are not covered by the Privacy Act. If you wish to make any inquiries about this Privacy Policy, you should contact Indevelop in any of the ways specified in clause 13.
            </p>
            <p>
              Indevelop may, from time to time, review and update this Privacy Policy, including to consider new laws, regulations, and technology. All Personal Information held by Indevelop will be governed by our most recent Privacy Policy, posted on our website.
            </p>
          </motion.div>
                ...
                <div className="space-y-4 text-primary/75 text-base font-light leading-[1.8]">
                  {section.body.map((item, i) => {
                    if (typeof item === 'string') {
                      ...
                      if (isSubheading) {
                        return (
                          <h3 key={i} className="font-semibold text-base text-primary pt-3">
                            {item}
                          </h3>
                        );
                      }
