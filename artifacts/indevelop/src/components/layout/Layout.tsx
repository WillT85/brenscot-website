      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-8 flex items-center justify-between">
          <Link href="/" className={`flex flex-col items-start leading-none z-10 transition-colors ${useWhiteText ? "text-white" : "text-primary"}`} data-testid="link-logo">
            ...
            <span className={`text-[8px] tracking-[0.3em] uppercase font-bold mt-0.5 font-sans ${useWhiteText ? "text-white/70" : "text-primary/50"}`}>Property Developers</span>
          </Link>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <div className="mb-6">
              ...
              <span className="text-[8px] tracking-[0.3em] uppercase font-bold font-sans text-white/50 mt-0.5 block">Property Developers</span>
            </div>
