      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          ...
          <p className="text-[#C8A24A] text-2xl md:text-4xl font-light leading-relaxed mb-10">
            ...
            <span className="block text-lg md:text-xl leading-relaxed mt-4">Indevelop identifies and acquires the sites; Brenscot takes it from there — design, approvals and construction through to a completed, ready-to-occupy building.</span>
          </p>
