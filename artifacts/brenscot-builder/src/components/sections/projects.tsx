            ...
            >
              <div className="relative overflow-hidden h-[35vh] md:h-[40vh]">
                ...
                <div className="absolute bottom-0 left-0 right-0 z-30 p-4 md:p-5">
                  <h3 className="inline-block text-xs font-serif font-semibold text-black tracking-wide uppercase bg-white/30 backdrop-blur-md border border-white/40 rounded-md px-3 py-2 shadow-sm">
