      ...
      <div className="container mx-auto px-6 md:px-12">
            ...
            >
              <div className="relative overflow-hidden h-[35vh] md:h-[40vh]">
                ...
                <div className="absolute inset-0 z-20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <span className="flex flex-col items-center gap-1 text-white text-xs font-bold uppercase tracking-[0.2em] border border-white/50 px-8 py-4 backdrop-blur-sm">
                    <span className="font-serif font-bold uppercase tracking-wide text-sm text-[#C8A24A]">Brenscot</span>
                    <span>View Project</span>
                  </span>
                </div>
                <div className="absolute bottom-0 left-0 right-0 z-30">
                  <div className="absolute inset-0 bg-gradient-to-t from-white/85 via-white/50 to-transparent" />
                  <h3 className="relative text-xs font-serif font-normal text-black tracking-wide uppercase p-4 md:p-5">
        ...
        <div className="mt-16 text-center">
          <button
            ...
            className="text-xs font-medium uppercase tracking-[0.2em] border border-[#C8A24A] text-[#C8A24A] bg-transparent px-10 py-4 hover:bg-[#C8A24A] hover:text-white transition-colors duration-300"
          >
